import java.util.Scanner;
 ...
 public static void main(String args[]){
       ...
       double r1;
       double r2;
       System.out.println("enter the coefficient of x2 which is a : ");
       int a=sc.nextInt();
       System.out.println("enter the coefficient of x which is b:  ");
       int b=sc.nextInt();
       System.out.println("enter the constant  c:  ");
       int c=sc.nextInt();
       System.out.println("therefore the equation is "+a+"x2"+b+"x"+c);
       if(a==0){
       System.out.println("you cannot enter 0 as the value of a ");
       }
       d=(b*b-4*a*c);
       if(a!=0)
       {
